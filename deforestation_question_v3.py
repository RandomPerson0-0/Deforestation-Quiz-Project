...
# this randomizes the question from 1-10
for i in range(1, 10):
    # the string adds the question_ with a random number from 1-10
    str = f"question_{i}()"
    print(str)

    eval(str)  # call functions on the top

    # tells the user how many scores they have
